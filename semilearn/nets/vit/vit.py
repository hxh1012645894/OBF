...
class Normalize(nn.Module):
    """L2 normalization layer for projector features"""
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, only_fc=False, only_feat=False, **kwargs):
        ...
        # Projector features for OBF-MANet (L2 normalized)
        proj_features = self.l2norm(self.fc2(self.relu_mlp(self.fc1(x))))

        result_dict = {'logits': logits, 'feat': x, 'proj_feat': proj_features}
        return result_dict
